...
function writeRoute(routePath, html) {
  ...
  html = html.replace(/privacy-controls\.css\?v=\d+/g, 'privacy-controls.css?v=5')
    ...
    .replace(/product-page\.css\?v=\d+/g, 'product-page.css?v=9');
...
for (const filename of fs.readdirSync(projectDir)) {
  if (!/\.(?:css|js|html)$/i.test(filename) || ["catalog.html", "product-preview.html", "privacy-policy.html", "personal-data-consent.html"].includes(filename)) continue;
...
<head>
  ...
  <link rel="stylesheet" href="/basket-drawer.css?v=1" />
...
<body>
  <header class="reference-header" data-header>
    ...
    <nav class="mobile-nav" id="product-mobile-navigation" aria-label="Мобильная навигация" hidden data-mobile-nav>
      <a href="/#company">О компании</a><a href="/#about">Преимущества</a><a href="/#workflow">Доставка</a><a href="/#orders">Кейсы</a><a href="/catalog/">Каталог</a><a class="mobile-nav-cta" href="tel:+79952453000">Связаться с нами</a>
    </nav>
  </header>
...
<body>
  <header class="site-header">
    <div class="site-header-shell">
      ...
      <div class="site-header-actions"><a class="header-cta" href="tel:+79952453000">Связаться с нами</a></div>
    </div>
  </header>
  <main class="product-page-main">
    <div class="product-page-shell">
